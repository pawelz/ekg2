...
void
gtkutil_file_req(const char *title, void *callback, void *userdata, char *filter, int flags)
{
...
gtkutil_clist_new(int columns, char *titles[],
		  ...
		  void *unselect_callback, gpointer unselect_userdata, int selection_mode)
{
	GtkWidget *clist, *win;
...
GtkWidget *
gtkutil_treeview_new(GtkWidget *box, GtkTreeModel * model, GtkTreeCellDataFunc mapper, ...)
{
	GtkWidget *win, *view;
