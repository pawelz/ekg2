...
staticforward PyMethodDef ekg_methods[] = {
	...
	{ "variable_add",      ekg_cmd_variable_add_str,  METH_VARARGS, "Add string variable with optional handler" },
	{ "variable_add_bool", ekg_cmd_variable_add_bool, METH_VARARGS, "Add boolean variable with optional handler" },
	{ "variable_add_int",  ekg_cmd_variable_add_int,  METH_VARARGS, "Add integer variable with optional handler" },
	{ "variable_add_str",  ekg_cmd_variable_add_str,  METH_VARARGS, "Add string variable with optional handler" },
